...
namespace Bacteria
{
    public class fluBCell : MonoBehaviour
    {
        //components
        ...
        void Update()
        {
            ...
            if (time >= spawnDelay)
            {
                GameObject newAntibody = (GameObject)Instantiate(fluAntibody, new Vector3(transform.position.x, transform.position.y, 474f), Quaternion.identity);
