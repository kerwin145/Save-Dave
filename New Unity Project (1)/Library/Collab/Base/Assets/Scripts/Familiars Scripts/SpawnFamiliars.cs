...
public void SpawnMonocyte(){
    ...
    public void removeMonocyte(GameObject yeet)
    {
        MonocyteList.Remove(yeet);
    }

    public List<GameObject> getMonocyteList()
    {
        return MonocyteList;
    }

    public GameObject getMonocyteListElement(int i)
    {
        return MonocyteList[i];
    }
